...
- **Trained Model:** The Trained model of this project is available for download here: [Pre-trained Model on Google Drive](https://drive.google.com/file/d/1n-NLX7-s-JSdolzof0Bk935gGLmz1tCF/view?usp=drive_link).
